...
GUICtrlCreatePic($appdata & "\app.jpg",0,0,80,80,0x04000000)
GUICtrlCreateGraphic(0,0,750,80,0x04000000)
	GUICtrlSetBkColor(-1,0x000000)
GUICtrlCreateGraphic(40,80,1,440)
	GUICtrlSetBkColor(-1,0x000000)

GUICtrlCreateLabel(_LNG_("label_ban"),50,0,650,80,BitOR(0x01,0x0200))
	GUICtrlSetFont(-1,20)
	GUICtrlSetColor(-1,0xffffff)
	GUICtrlSetBkColor(-1,-2)

$label_profile = GUICtrlCreateLabel(_LNG_("label_profile") & " : ---",50,55,650,20,BitOR(0x01,0x0200))
	GUICtrlSetFont(-1,10)
	GUICtrlSetColor(-1,0xffffff)
	GUICtrlSetBkColor(-1,-2)
...
$button_download = GUICtrlCreateButton(_LNG_("button_download"),295,380,200,40)
	GUICtrlSetFont(-1,18)
	GUICtrlSetOnEvent(-1,"_SteamCMD_")
$label_console = GUICtrlCreateLabel("",45,190,700,325,BitOR(0x01,0x0200,0x04000000),0x00000200)
	GUICtrlSetFont(-1,20)
	GUICtrlSetColor(-1,0xffffff)
	GUICtrlSetBkColor(-1,0x000000)
